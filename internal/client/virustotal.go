...
func (c *URLClient) ScanURL(ctx context.Context, rawURL string) (*model.VTResult, error) {
...
func (c *URLClient) vtGetReport(ctx context.Context, urlID string) (*model.VTResult, error) {
...
func (c *URLClient) vtWaitAnalysis(ctx context.Context, analysisID string) (*model.VTResult, error) {
